...
f_RS=open("Reporting Requirements.txt", "r")
items_RS=f_RS.read()
...
def tokenify_glossary(report):
    ...
    if buff is not None:
        ...
        buff=''
    return sentences
#print(tokenify_glossary(items_RS))
...
def divide_glossary(sentences):
    ...
    return POS
#print(divide_glossary(tokenify_glossary(items_RS)))
...
def sort_glossary(POS):
    ...
    return sorted_POS
sort_glossary(divide_glossary(tokenify_glossary(items_RS)))
print(sort_glossary(divide_glossary(tokenify_glossary(items_RS))))
